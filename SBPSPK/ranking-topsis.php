...
foreach($matriks_x as $id_kriteria => $nilai_alternatives):
	...
	$jumlah_kuadrat = 0;
	foreach($nilai_alternatives as $nilai_alternative):
		$jumlah_kuadrat += pow($nilai_alternative, 2);
	endforeach;
	$akar_kuadrat = sqrt($jumlah_kuadrat);
	
	// Mencari hasil bagi akar kuadrat
	// Lalu dimasukkan ke array $matriks_r
	foreach($nilai_alternatives as $id_alternative => $nilai_alternative):
		$matriks_r[$id_kriteria][$id_alternative] = $nilai_alternative / $akar_kuadrat;
	endforeach;
				...
				<?php foreach($alternatives as $alternative ): ?>
					<tr>
						...
						<td>
							<?php								
							$id_alternative = $alternative['id_alternative'];
							echo round($jarak_ideal_positif[$id_alternative], $digit);
							?>
						</td>						
					</tr>
				<?php endforeach; ?>
				...
				<?php foreach($alternatives as $alternative ): ?>
					<tr>
						...
						<td>
							<?php								
							$id_alternative = $alternative['id_alternative'];
							echo round($jarak_ideal_negatif[$id_alternative], $digit);
							?>
						</td>						
					</tr>
				<?php endforeach; ?>
